...
if ($manifest.package -ne 'codex-fpga-engineering-workflow' -or $manifest.scope -ne $Scope) { throw 'Manifest identity or scope mismatch.' }
...
Write-Host 'Uninstall pass complete. No directory tree was recursively removed.'
